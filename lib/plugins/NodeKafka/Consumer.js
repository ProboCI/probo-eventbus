...
class KafkaConsumer {
  ...
  constructor(options, done) {
    ...
    this[_stream] = through2.obj(streamOptions);
    this[_rawStream] = through2.obj(streamOptions);
    var self = this;
  ...
  messageHandler(message) {
    try {
      ...
      // Only pass up messages that match the version number if it's supplied.
      if (typeof this.version === 'undefined' || message.version === this.version) {
